...
<div style="min-height:100vh; background:#f8fafc; padding:40px 20px;">

  <div style="max-width:760px; margin:0 auto;">

    <a href="<%= request.getContextPath() %>/" style="display:inline-flex; align-items:center; gap:4px; color:#64748b; font-size:13px; text-decoration:none; margin-bottom:20px;">← Back</a>
    ...
    <div style="background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:28px; margin-bottom:16px;">
      <div style="display:flex; align-items:center; gap:18px;">
        <div style="width:64px; height:64px; border-radius:50%; background:#4f46e5; display:flex; align-items:center; justify-content:center; color:#fff; font-family:'Outfit',sans-serif; font-size:22px; font-weight:800; flex-shrink:0;">
          <%= initials %>
        </div>
        <div>
          <h1 style="font-family:'Outfit',sans-serif; font-size:24px; font-weight:800; color:#0f172a; margin:0 0 4px;"><%= firstName %> <%= lastName %></h1>
          <p style="font-size:13px; color:#64748b; margin:0 0 8px;"><%= email %></p>
          <div style="display:flex; gap:6px;">
            <span style="padding:3px 10px; border-radius:99px; font-size:11px; font-weight:600; background:#e0e7ff; color:#4338ca;"><%= role %></span>
    ...
    <div style="display:grid; grid-template-columns:1.4fr 1fr; gap:16px;">
      ...
      <div style="background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:24px;">
        <h2 style="font-size:16px; font-weight:700; color:#0f172a; margin-bottom:18px;">Edit Profile</h2>
        ...
        <form action="<%= request.getContextPath() %>/profile" method="post">
          ...
          <button type="submit" style="background:#4f46e5; color:#fff; border:none; font-weight:600; font-size:14px; padding:10px 22px; border-radius:8px; cursor:pointer; font-family:'Inter',sans-serif;">
            Save changes
          </button>
        </form>
      </div>
