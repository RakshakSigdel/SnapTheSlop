  ...
  <div class="flex-1" style="margin-left:220px; background:#f8fafc; min-height:100vh;">
    ...
    <div style="padding:18px 32px; display:flex; align-items:center; justify-content:space-between; border-bottom:1px solid #e2e8f0; background:#fff;">
      <div>
        ...
        <p style="font-size:13px; color:#64748b; margin:2px 0 0;">Platform-wide control over citizens, municipalities, and issue workflows.</p>
      </div>
    ...
    <div style="padding:28px 32px;">
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr 1fr 1fr; gap:14px; margin-bottom:28px;">
        ...
        <div style="background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:18px 20px;">
          ...
          <span style="font-family:'Outfit',sans-serif; font-size:28px; font-weight:800; color:#0f172a;">38</span>
        </div>
        <div style="background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:18px 20px;">
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:16px; margin-bottom:20px;">
        <a href="<%= request.getContextPath() %>/admin/users" style="text-decoration:none; display:flex; align-items:center; gap:14px; background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:20px; transition:box-shadow 0.2s;" onmouseover="this.style.boxShadow='0 2px 8px rgba(0,0,0,0.04)'" onmouseout="this.style.boxShadow='none'">
        ...
        <a href="<%= request.getContextPath() %>/admin/municipalities" style="text-decoration:none; display:flex; align-items:center; gap:14px; background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:20px; transition:box-shadow 0.2s;" onmouseover="this.style.boxShadow='0 2px 8px rgba(0,0,0,0.04)'" onmouseout="this.style.boxShadow='none'">
          <div style="width:40px; height:40px; border-radius:8px; background:#d1fae5; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
        ...
        <a href="<%= request.getContextPath() %>/admin/manage-issues" style="text-decoration:none; display:flex; align-items:center; gap:14px; background:#059669; border:1px solid #059669; border-radius:10px; padding:20px; transition:box-shadow 0.2s;" onmouseover="this.style.boxShadow='0 2px 8px rgba(0,0,0,0.08)'" onmouseout="this.style.boxShadow='none'">
          ...
          <div>
            ...
            <p style="font-size:12px; color:rgba(255,255,255,0.82);">Filter, sort and take actions</p>
          </div>
        </a>
      </div>
