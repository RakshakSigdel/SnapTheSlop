...
<!-- h-[80vh] sets height to 80% of the page. flex-col allows vertical layout. -->
<div class="fixed top-0 left-0 h-[80vh] bg-white border-r border-gray-200 flex flex-col z-50" style="width: 208px;">
    ...
    <!-- Navigation Section -->
    <nav class="px-3 py-4 space-y-1 flex-shrink-0">
    ...
    <!-- 'mt-auto' pushes this section to the very bottom of the flex container -->
